...
# zpush
	...
	cat > /var/www/zpush/mail/config-v1.1-$MYOTHERDOMAIN.xml <<END
...
END
		...
		echo " @     		 TXT       \"mailconf=https://autoconfig.${MYOTHERDOMAIN}/config-v1.1-$MYOTHERDOMAIN.xml\"" | awk '{ print strftime("[%H:%M:%S] |"), $0 }'
