...
DEBIAN_FRONTEND=noninteractive aptitude -y install apache2-dev apache2-utils apt-listchanges arj autoconf automake bison bsd-mailx build-essential bzip2 ca-certificates cabextract checkinstall curl file flex git htop libapr1-dev libaprutil1 libaprutil1-dev libauthen-sasl-perl libawl-php libcunit1-dev libcrypt-ssleay-perl libcurl4-openssl-dev libdbi-perl libgeoip-dev libio-socket-ssl-perl libio-string-perl liblockfile-simple-perl liblogger-syslog-perl libmail-dkim-perl libmail-spf-perl libmime-base64-urlsafe-perl libnet-dns-perl libnet-ident-perl libnet-LDAP-perl libnet1 libnet1-dev libpam0g-dev libpcre-ocaml-dev libpcre3 libpcre3-dev libreadline6-dev libtest-tempdir-perl libtool libuv0.10-dev libwww-perl libxml2 libxml2-dev libxml2-utils libxslt1-dev libyaml-dev lzop mariadb-server mc memcached mlocate nettle-dev nomarch php-auth-sasl php-http-request php-mail php-mail-mime php-mail-mimedecode php-net-dime php-net-smtp php-net-url php-pear php-soap php7.0 php7.0-apcu php7.0-cli php7.0-common php7.0-curl php7.0-dev php7.0-fpm php7.0-geoip php7.0-gd php7.0-igbinary php7.0-imap php7.0-intl php7.0-mcrypt php7.0-mysql  php7.0-sqlite3 php7.0-xmlrpc php7.0-xsl pkg-config python-setuptools python-dev python-software-properties rkhunter software-properties-common subversion sudo unzip vim-nox zip zlib1g zlib1g-dbg zlib1g-dev zoo
