...
#apt-get -qq update && apt-get -q -y --force-yes install php-mail-mimedecode php-auth-sasl/unstable php-http-request/unstable php-mail/unstable php-mail-mime/unstable php-net-dime/unstable php-net-smtp/unstable php-net-url/unstable php-pear/unstable php-apcu/unstable php-geoip/unstable php-igbinary/unstable php$PHPVERSION7/unstable php$PHPVERSION7-cli/unstable php$PHPVERSION7-common/unstable php$PHPVERSION7-curl/unstable php$PHPVERSION7-dev/unstable php$PHPVERSION7-fpm/unstable php$PHPVERSION7-gd/unstable php$PHPVERSION7-intl/unstable php$PHPVERSION7-mcrypt/unstable php$PHPVERSION7-mysql/unstable php$PHPVERSION7-soap/unstable php$PHPVERSION7-sqlite3/unstable php$PHPVERSION7-xsl/unstable php$PHPVERSION7-xmlrpc/unstable php$PHPVERSION7-imap/unstable php-mbstring/unstable php-xml/unstable php$PHPVERSION7-json/unstable php$PHPVERSION7-opcache/unstable php$PHPVERSION7-readline/unstable php$PHPVERSION7-xml/unstable php$PHPVERSION7-mbstring/unstable ${log}
#$PURGE_PHP5=$(dpkg -l | grep php5)
apt-get purge -y php5* ${log}
apt-get purge -y php7* ${log}
apt-get install -f -y -t testing php-auth-sasl php-http-request php$PHPVERSION7-bcmath php$PHPVERSION7-zip php-mail php-net-dime php-net-url php-pear php-apcu php$PHPVERSION7 php$PHPVERSION7-cli php$PHPVERSION7-common php$PHPVERSION7-curl php$PHPVERSION7-dev php$PHPVERSION7-fpm php$PHPVERSION7-intl php$PHPVERSION7-mcrypt php$PHPVERSION7-mysql php$PHPVERSION7-soap php$PHPVERSION7-sqlite3 php$PHPVERSION7-xsl php$PHPVERSION7-xmlrpc php-mbstring php-xml php$PHPVERSION7-json php$PHPVERSION7-opcache php$PHPVERSION7-readline php$PHPVERSION7-xml php$PHPVERSION7-mbstring ${log}
